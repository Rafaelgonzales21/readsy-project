    ...
    const navLink = (to, label) => (
        <Link
            ...
            style={{
                ...
                borderRadius: 6,
                textDecoration: "none",
                color: location.pathname === to ? "#0a0a0a" : "#737373",
                background: location.pathname === to ? "#f5f5f5" : "transparent",
    ...
    return (
        <nav className="navbar">
            <div style={{
                ...
                {/* Navegación central — solo con sesión */}
                {user && (
                ...
                {!user && (
                    <span style={{
                        fontSize: "0.75rem", color: "#737373", fontWeight: 500,
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: "#737373", background: "none",
                                border: "1px solid #e5e5e5", borderRadius: 6,
                                padding: "0.35rem 0.75rem", cursor: "pointer",
                                letterSpacing: "0.02em", transition: "all 0.15s ease",
                            }}
                            onMouseEnter={(e) => { e.target.style.color = "#0a0a0a"; e.target.style.borderColor = "#0a0a0a"; }}
                            onMouseLeave={(e) => { e.target.style.color = "#737373"; e.target.style.borderColor = "#e5e5e5"; }}
                        >
                            Cerrar sesión
                        </button>
                    </div>
